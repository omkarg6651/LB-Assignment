...
int SearchLastOcc(PPNODE Head,int elem)
{
	PNODE temp = *Head;
	int iCnt = 1,i = 0;
...
int main()
{
    ...
    int iChoice = 1, value = 0, iRet = 0, pos = 0,iRet1 = 0,elem = 0;
    ...
    while(iChoice != 0)
    {
		...
		printf("9 : Search for Last occurence\n");
        ...
        switch(iChoice)
        {
			...
			case 9:
				...
				scanf("%d",&elem);
				iRet1 = SearchLastOcc(&first,elem);
				printf("Number is present at %d",iRet1);
				break;
