...
int SearchFirstOcc(PPNODE Head,int elem)
{
	PNODE temp = *Head;
	int i = 1;
...
int main()
{
    ...
    int iChoice = 1, value = 0, iRet = 0, pos = 0,elem = 0,iRet1 = 0;
    ...
    while(iChoice != 0)
    {
		...
		printf("9 : Search first occurence\n"); 
        ...
        switch(iChoice)
        {
			...
			case 9:
				...
				scanf("%d",&elem);
				iRet1 = SearchFirstOcc(&first,elem);
